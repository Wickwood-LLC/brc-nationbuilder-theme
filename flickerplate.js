		...
		init 							: function()
		{
			...
			function fc_attach_arrows()
			{
				if(($settings.flick_animation != 'scroller-slide') && ($settings.arrows == true))
				{
					...
					$flicker.find('.slide-1 .take-action').on('click', function()
					{
						if(++$settings.flick_position > $flick_count)
						{
							$settings.flick_position	= $settings.arrows_constraint ? ($flick_count) : 1;
					...
					$flicker.find('.slide-1 .subscribe-news').on('click', function()
					{
						if(++$settings.flick_position > $flick_count)
						{
							$settings.flick_position	= $settings.arrows_constraint ? ($flick_count) : 1;
					...
					$flicker.find('.slide-2 .watch-video').on('click', function()
					{
						if(--$settings.flick_position < 1)
						{
							$settings.flick_position	= $settings.arrows_constraint ? 1 : ($flick_count);
					...
					$flicker.find('.slide-2 .subscribe-news').on('click', function()
					{
						if(++$settings.flick_position > $flick_count)
						{
							$settings.flick_position	= $settings.arrows_constraint ? ($flick_count) : 1;
					...
					$flicker.find('.slide-3 .watch-video').on('click', function()
					{
						if(--$settings.flick_position < 1)
						{
							$settings.flick_position	= $settings.arrows_constraint ? 1 : ($flick_count);
					...
					$flicker.find('.slide-3 .take-action').on('click', function()
					{
						if(--$settings.flick_position < 1)
						{
							$settings.flick_position	= $settings.arrows_constraint ? 1 : ($flick_count);
